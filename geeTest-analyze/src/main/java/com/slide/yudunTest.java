...
//网易
public class yudunTest {

    private WebDriver driver;
    private WebDriver.Navigation navigation;
    private String baseUrl = "http://dun.163.com/trial/jigsaw";
    //private static boolean moveArrayInit = false;
    //private static int[][] moveArray = new int[52][2];

    @Test
    public void testYundunTest(){
        try {
            //设置firefox浏览器的位置
    ...
    public int yudunTest1() throws InterruptedException, IOException, ImageReadException {
        //加载到指定url
        navigation.to(baseUrl);
        Actions actions = new Actions(driver);
        Thread.sleep(500);
        String xiaotu = driver.findElement(By.className("yidun_jigsaw")).getAttribute("src");
        String quantu = driver.findElement(By.className("yidun_bg-img")).getAttribute("src");
        System.out.println("xiaotu = " + xiaotu);
        System.out.println("quantu = " + quantu);
        download(xiaotu,"wangyiquekou.jpg","D://");
        download(quantu,"wangyiquantu.jpg","D://");
        Thread.sleep(500);
        WebElement slider_button = driver.findElement(By.className("yidun_slider__icon"));
